const contractAddress = "0x94BA72ec316A27F9d9c2fD0B4EA794b99d22bFB3"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Happy Flamingos Holders Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Happy Flamingos Holders Club NFT Project is a 5000 hand-drawn NFT Collection. Our main goal is to use web3 in order to create a community to share ideas inside the metaverse. Our early supporters will also have unique benefits to our future HF coin and game <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
